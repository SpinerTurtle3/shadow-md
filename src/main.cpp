...
String PS3ControllerFootMac = "00:06:F7:3C:8C:14"; // Set this to your FOOT PS3 controller MAC address
String PS3ControllerDomeMAC = "04:76:6E:4E:51:FC"; // Set to a secondary DOME PS3 controller MAC address (Optional)
...
void onInitPS3NavFoot()
{
    ...
    if (btAddress == PS3ControllerFootMac || btAddress == PS3ControllerBackupFootMac)
    {
        ...
        writeControlerBatteryStatusToOutput(PS3NavFoot);
#endif
...
void onInitPS3NavDome()
{
    ...
    if (btAddress == PS3ControllerDomeMAC || btAddress == PS3ControllerBackupDomeMAC)
    {
        ...
        writeControlerBatteryStatusToOutput(PS3NavDome);
#endif
...
{
    String status = "";
    if (myPS3->getStatus(Low))
    {
        status = "Low";
    }
    else if (myPS3->getStatus(High))
    {
        status = "High";
    }
    else if (myPS3->getStatus(Full))
    {
        status = "Full";
    }

    output += "Controller Battery Status: ";
    output += status;
    output += "\r\n";
}
